...
class _LoginState extends State<Login> {
  ...
  bool doLogin()
  {
    ...
    if (((usernameController.text==_login.paul.userName) && (passwordController.text == _login.paul.password) )
        || ((usernameController.text==_login.tom.userName) && (passwordController.text == _login.tom.password) ))
    {
...
class TempLogin
{
  ...
  List<String> tomRoles = ['cms_ww_read_only','cms_project_admin','cms_sysadmin'];
  LoginDetails paul = LoginDetails(userID: 1,userName: 'paul',clientIPAddress: '127.0.0.1', password: 'paul1');
  LoginDetails tom = LoginDetails(userID: 1,userName: 'tom',clientIPAddress: '127.0.0.1',  password: 'tom1');
